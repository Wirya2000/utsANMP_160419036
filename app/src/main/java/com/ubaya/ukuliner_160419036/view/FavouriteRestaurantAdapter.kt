...
class FavouriteRestaurantAdapter(val restaurantList:ArrayList<Restaurant>) : RecyclerView.Adapter<FavouriteRestaurantAdapter.RestaurantViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RestaurantViewHolder {
        ...
        return FavouriteRestaurantAdapter.RestaurantViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: RestaurantViewHolder, position: Int) {
        ...
        with(holder.view) {
            ...
            cardViewRestaurant.setOnClickListener {
                val action = FavouriteRestaurantFragmentDirections.actionFavouriteToRestaurant(restaurant.id.toString())
